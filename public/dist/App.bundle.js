...
function autocomplete(input, latInput, lngInput) {
  ...
  // prevent form submission when hitting enter on address field
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 34.06;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -118.3;
...
function typeAhead(search) {
  ...
  // handle up, down & enter keyboard inputs
